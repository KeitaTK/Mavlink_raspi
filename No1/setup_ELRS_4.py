...
params_to_set = {
    ...
    'PSC_VELXY_P': (10.0, 'AP_Float', '水平速度制御P'),
    ...
    'ATC_ACCEL_R_MAX': (90000, 'AP_Int16', 'Roll最大加速度[deg/s^2] (例:90000)'),
    'ATC_ACCEL_P_MAX': (90000, 'AP_Int16', 'Pitch最大加速度[deg/s^2] (例:90000)'),
    'ATC_ACCEL_Y_MAX': (45000, 'AP_Int16', 'Yaw最大加速度[deg/s^2] (例:45000)'),
