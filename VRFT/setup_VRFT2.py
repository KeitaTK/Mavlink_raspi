"""
改善版: ArduPilotパラメータ設定スクリプト (VRFT用)
主な改善点：
...
params_to_set = {
    ...
    'PSC_POSZ_P': (1.0, 'AP_Float', '垂直位置制御P'),
    
    # === 速度制御 ===
    'PSC_VELXY_P': (3.0, 'AP_Float', '水平速度制御P'),
    'PSC_VELXY_I': (2.5, 'AP_Float', '水平速度制御I'),
    'PSC_VELXY_D': (0.5, 'AP_Float', '水平速度制御D'),
    'PSC_VELXY_FF': (0.0, 'AP_Float', '水平速度制御FF'),
    
    'PSC_VELZ_P': (4.0, 'AP_Float', '垂直速度制御P'),
    'PSC_VELZ_I': (8.0, 'AP_Float', '垂直速度制御I'),
    'PSC_VELZ_D': (0.01, 'AP_Float', '垂直速度制御D'),
    'PSC_VELZ_FF': (0.0, 'AP_Float', '垂直速度制御FF'),
    
    # === 加速度制御 ===
    'PSC_ACCZ_P': (0.3, 'AP_Float', '垂直加速度制御P'),
    'PSC_ACCZ_I': (1.0, 'AP_Float', '垂直加速度制御I'),
    'PSC_ACCZ_D': (0.0, 'AP_Float', '垂直加速度制御D'),
    'PSC_ACCZ_FF': (0.0, 'AP_Float', '垂直加速度制御FF'),
    
    # === 姿勢角度制御 ===
    'ATC_ANG_RLL_P': (6.0, 'AP_Float', 'Roll Angle P'),
    'ATC_ANG_PIT_P': (6.0, 'AP_Float', 'Pitch Angle P'),
    'ATC_ANG_YAW_P': (4.5, 'AP_Float', 'Yaw Angle P'),
    
    # === 姿勢角速度制御 ===
    'ATC_RAT_RLL_P': (0.035, 'AP_Float', 'Roll Rate P'),
    'ATC_RAT_RLL_I': (0.0, 'AP_Float', 'Roll Rate I'),
    'ATC_RAT_RLL_D': (0.0005, 'AP_Float', 'Roll Rate D'),
    'ATC_RAT_RLL_FF': (0.0, 'AP_Float', 'Roll Rate FF'),
    'ATC_RAT_RLL_FLTD': (0.0, 'AP_Float', 'Roll Rate D-term filter'),
    'ATC_RAT_RLL_FLTT': (0.0, 'AP_Float', 'Roll Rate Target filter'),
    'ATC_RAT_RLL_FLTE': (0.0, 'AP_Float', 'Roll Rate Error filter'),
    
    'ATC_RAT_PIT_P': (0.05, 'AP_Float', 'Pitch Rate P'),
    'ATC_RAT_PIT_I': (0.0, 'AP_Float', 'Pitch Rate I'),
    'ATC_RAT_PIT_D': (0.0012, 'AP_Float', 'Pitch Rate D'),
    'ATC_RAT_PIT_FF': (0.0, 'AP_Float', 'Pitch Rate FF'),
    'ATC_RAT_PIT_FLTD': (0.0, 'AP_Float', 'Pitch Rate D-term filter'),
    'ATC_RAT_PIT_FLTT': (0.0, 'AP_Float', 'Pitch Rate Target filter'   ),
    'ATC_RAT_PIT_FLTE': (0.0, 'AP_Float', 'Pitch Rate Error filter'),
    
    'ATC_RAT_YAW_P': (0.2, 'AP_Float', 'Yaw Rate P'),
    'ATC_RAT_YAW_I': (0.0, 'AP_Float', 'Yaw Rate I'),
    'ATC_RAT_YAW_D': (0.0, 'AP_Float', 'Yaw Rate D'),
    'ATC_RAT_YAW_FF': (0.0, 'AP_Float', 'Yaw Rate FF'),
    'ATC_RAT_YAW_FLTE': (0.0, 'AP_Float', 'Yaw Rate Error filter'),
    'ATC_RAT_YAW_FLTT': (0.0, 'AP_Float', 'Yaw Rate Target filter'),
    ...
    'SID_AXIS': (7, 'AP_Int8', 'チャープを入れる軸'),
    'SID_MAGNITUDE': (60, 'AP_Int8', 'チャープ信号振幅'),
    'SID_F_START_HZ': (0.5, 'AP_Float', 'チャープ開始周波数 [Hz]'),
    'SID_F_STOP_HZ': (2.0, 'AP_Float', 'チャープ終了周波数 [Hz]'),
    'SID_T_FADE_IN': (5, 'AP_Int8', 'フェードイン時間 [s]'),
    'SID_T_FADE_OUT': (3, 'AP_Int8', 'フェードアウト時間 [s]'),
    'SID_T_REC': (60, 'AP_Int8', 'データ取得時間 [s]'),
    ...
    'LOG_BITMASK': (655358, 'AP_Int32', 'VRFT/SysID用：IMU, ATTitude, RATE, PIDs, ATUN(SysID)'),
    'LOG_REPLAY': (0, 'AP_Int8', 'ログリプレイ無効'),
    'LOG_FILE_MB_FREE': (500, 'AP_Int16', '最低空き容量 [MB]'),
